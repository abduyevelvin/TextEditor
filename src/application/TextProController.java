	...
	private void handleFleschIndex() {
		...
		if(!text.equals("")) {
			...
			if(fIndex < 30.00) {
				...
				fleschField.setStyle("-fx-text-fill: red; -fx-font-weight: bold");
			} else if(fIndex > 90.00) {
				fleschField.setText(fString);
				fleschField.setStyle("-fx-text-fill: green; -fx-font-weight: bold");
			} else {
				// display string in text field
				fleschField.setText(fString);
				fleschField.setStyle("-fx-text-fill: black; -fx-font-weight: bold");
			}
